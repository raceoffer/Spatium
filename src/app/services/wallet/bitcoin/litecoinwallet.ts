...
export class LitecoinWallet extends CurrencyWallet {
  ...
  constructor(
    ...
    super(network, keychain, Coin.LTC, account, messageSubject, bt, ngZone);
  }
  ...
  public fromJSON(tx) {
    return CryptoCore.LitecoinTransaction.fromJSON(tx);
  }
  ...
  public async finishSync(data) {
    ...
    this.provider = new CryptoCore.InsightProviderLTC({
      network: this.network
    });
  ...
  public async createTransaction(
    ...
    const transaction = CryptoCore.LitecoinTransaction.fromOptions({
      network: this.network
    });
